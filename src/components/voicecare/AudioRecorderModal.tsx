  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-xl p-6 sm:p-8 rounded-3xl">
        ...
        {/* Consent / Privacy Tag */}
        <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground/80 bg-muted/40 py-1.5 px-3 rounded-xl">
          <ShieldCheck className="h-3.5 w-3.5 text-emerald-500" />
          <span>Patient-controlled voice consent & role-based privacy active</span>
        </div>
            ...
            {state === "idle" && (
              <div className="flex flex-col items-center space-y-4">
                <button
                  ...
                  className="group relative flex h-28 w-28 items-center justify-center rounded-full bg-gradient-to-tr from-emerald-600 to-teal-500 text-white shadow-xl shadow-emerald-500/25 transition-all hover:scale-105 active:scale-95 focus:outline-none focus:ring-4 focus:ring-emerald-500/30"
                >
                  <span className="absolute -inset-1 rounded-full bg-emerald-500/20 blur-md group-hover:bg-emerald-500/30 transition-all" />
                  <Mic className="h-12 w-12 transition-transform group-hover:scale-110" />
                </button>
                <div className="text-center space-y-1">
                  <p className="font-semibold text-foreground text-base">Tap to speak naturally</p>
                  <p className="text-xs text-muted-foreground">Hausa, Pidgin, Yoruba, Igbo & English supported</p>
                </div>
              </div>
            )}
              ...
              <div className="flex flex-col items-center space-y-4">
                <div className="relative flex h-28 w-28 items-center justify-center">
                  ...
                  <button
                    ...
                    className="relative flex h-24 w-24 items-center justify-center rounded-full bg-rose-600 text-white shadow-xl shadow-rose-500/30 hover:bg-rose-700 transition-all focus:outline-none"
                  >
